(function () {
	app.directive('importChoose', [
		'nwService', '$mdToast', 'configService', function (nwService, $mdToast, configService) {
			return {
				restrict: 'AE',
				replace: 'true',
				require: 'ngModel',
				...
				link ($scope, elem) {
					...
					z.addEventListener('change', function () {
						if (this.value !== '') nwService.readJSON(this.value).then(function (obj) {
