		...
		'nwService', function (nwService) {
			return {
				...
				link ($scope, elem, att/* , ngModel */) {
					...
					if (typeof $scope.ngModel !== 'undefined' && $scope.ngModel !== '') $scope.wdir = $scope.ngModel.substring(0, $scope.ngModel.lastIndexOf(nwService.pathsep));
